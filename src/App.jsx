...
function App() {
  ...
  return (
    <div className="w-full">
      {/* navbar */}
      <div className="px-24 h-20 p-2 bg-blue-100 w-full border-b-2 border-blue-200 flex items-center justify-between">
        <div className="text-3xl italic text-indigo-600 text font-bold">
        ...
        <div>
          <button className="text-center text-slate-200 py-2 px-4 border-1 border-indigo-400 rounded-full bg-indigo-500 hover:bg-indigo-600 hover:transition-all ">Login / SignUp</button>
        </div>
      </div>
      ...
      <div className="flex justify-center">
        <div className="w-4/5 flex flex-col items-start ">
          ...
          {/* search filters */}
          <div className=" mt-20 h-24 lg:h-16 flex flex-wrap self-center border-2 border-slate-200 rounded-md shadow-xl ring-slate-300 lg:p-8 lg:flex-nowrap">
            <form className="flex flex-wrap md:flex-nowrap  items-center" action="">
              ...
              <div className="mx-6 flex flex-wrap lg:flex-nowrap relative ">
              ...
              <button
                type="submit"
                className="mx-2 px-2 lg:p-1  w-20 text-center text-slate-100  border-2 border-indigo-500 rounded-full bg-indigo-500 hover:bg-indigo-600 hover:text-slate-100 hover:scale-105 hover:transition"
                onClick={(e) =>
                  handleSearch(
                    e,
                    locationValue,
